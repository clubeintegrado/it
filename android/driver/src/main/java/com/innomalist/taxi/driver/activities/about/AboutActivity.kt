...
class AboutActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val licenseElement = Element().setTitle(getString(R.string.legal_notices)).setIconDrawable(R.drawable.copyright).setOnClickListener {
            ...
            notices.addNotice(Notice("CircleImageView", "https://github.com/hdodenhof/CircleImageView", "Henning Dodenhof", ApacheSoftwareLicense20()))
        ...
        if (getString(R.string.playStore) != "") aboutPage.addPlayStore(getString(R.string.playStore))
