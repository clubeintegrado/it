...
class TravelsActivity : BaseActivity(), OnWriteComplaintInteractionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.setStateDisplay(EmptyStateRecyclerView.STATE_EMPTY, ImageTextStateDisplay(this, R.drawable.empty_state, "Oops!", "Nothing to show here :("))
        binding.recyclerView.setStateDisplay(EmptyStateRecyclerView.STATE_ERROR, ImageTextStateDisplay(this, R.drawable.empty_state, "SORRY...!", "Something went wrong :("))
    ...
    private fun loadList(requests: ArrayList<Request>?) {
        ...
        val adapter = TravelsRecyclerViewAdapter(this@TravelsActivity, requests, object : OnTravelItemInteractionListener {
            override fun onHideTravel(travel: Request) {
                AlertDialogBuilder.show(this@TravelsActivity, getString(R.string.question_hide_travel), AlertDialogBuilder.DialogButton.OK_CANCEL, AlertDialogEvent { result: DialogResult ->
                    ...
                    HideHistoryItem(travel.id!!).execute<EmptyClass> {
            ...
            override fun onWriteComplaint(travel: Request) {
                lastSelectedTravelId = travel!!.id!!.toLong()
