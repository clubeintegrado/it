...
class WriteComplaintDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        alertDialogBuilder.setPositiveButton(getString(R.string.alert_ok)) { dialog: DialogInterface?, which: Int ->
        ...
        alertDialogBuilder.setNegativeButton(getString(R.string.alert_cancel)) { dialog: DialogInterface?, which: Int ->
            dialog?.dismiss()
        }
