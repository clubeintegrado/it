...
class AboutViewController: FormViewController {
    override func viewDidLoad() {
        super.viewDidLoad()
        form +++ Section(header: NSLocalizedString("about.section.info", value: "Info", comment: ""), footer: NSLocalizedString("about-footer", value: "© 2019 Minimalistic Apps All rights reserved.", comment: ""))
            <<< LabelRow(){
